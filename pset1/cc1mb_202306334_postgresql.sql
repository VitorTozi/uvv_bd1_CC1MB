...
--Muda a role do user postgres para o vitor
set role vitor;
...
\connect "dbname=uvv user=vitor password=tozi0905";
...
CREATE TABLE lojas.Produtos (
              ...
              ----Comentarios tabela produtos----


COMMENT ON TABLE lojas.Produtos IS 'Tabela sobre os Produtos com os dados de nome, detalhes e imagem';
...
CREATE TABLE lojas.Lojas (
                ...
                CONSTRAINT lojas_pk 
                PRIMARY KEY (loja_id),
                CONSTRAINT check_logo
                CHECK (logo IS NOT NULL)
);

              ----Comentarios tabela lojas----
...
CREATE TABLE lojas.Estoques (
                ...
                CONSTRAINT check_quantidade_id
                CHECK (quantidade >= 0)
);

              ----Comentarios tabela estoque----


COMMENT ON TABLE lojas.Estoques               IS     'Tabela do Estoque';
...
CREATE TABLE lojas.clientes (
                ...
                CONSTRAINT check_telefone3
                CHECK (telefone3 IS NULL)
                
);
         
              ----Comentarios tabela clientes----
...
CREATE TABLE lojas.pedido_itens (
              ...
              ----Comentarios tabela pedidos_itens----
              

COMMENT ON TABLE lojas.pedido_itens                        IS     'Tabela pedidos-itens';
